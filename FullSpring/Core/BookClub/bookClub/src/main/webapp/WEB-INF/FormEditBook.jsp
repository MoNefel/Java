...
<div class="container">
	...
	<div class="container">
		<form:form action="/book/${book.id}/update" modelAttribute="book" class="form" method="put">
			...
			<div class="form-row">
				...
				<form:label for="author" path="authorName">Author:</form:label>
		...
		<button class="btn-warning"><a href="/book/${book.id}/delete">delete book</a></button>
	</div>
